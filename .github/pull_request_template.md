...
- [ ] `SKILL.md` version was bumped if the workflow changed.
- [ ] `CHANGELOG.md` has an entry for the current `SKILL.md` version.
...
- [ ] `python3 scripts/validate-docs.py --skill-repo .` passes.
